...
Revision ID: e5c6e81954c9
Revises: 
Create Date: 2023-08-14 20:27:27.434158
...
def upgrade():
    ...
    sa.Column('document_type', sa.Enum('DNI', 'CIF', name='iddocument'), nullable=True),
